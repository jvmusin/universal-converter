...
public interface MeasurementConverterFactory<TWeight extends Number<TWeight>> {
    /**
     * Создаёт {@link MeasurementConverter} на весах типа {@link TWeight} из правил конвертации {@code conversionRules}.
     *
     * @param conversionRules правила конвертации с весами типа {@link TWeight}.
     * @return {@link MeasurementConverter}, работающий по правилам, указанным в {@code conversionRules}.
