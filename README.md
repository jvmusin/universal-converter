...
Быстро теряет точность и уже на небольших сетях будет выдавать большую накопленную погрешность.  
...
заплатить большим потреблением памяти и медленной работой конвертера в целом.  
...
- GitHub
- GitHub Maven Build GitHub Action
